        ...
        <>
            <div className="max-w-md mx-auto mb-4 rounded-full dark:shadow-2xl dark:shadow-green-300/20 shadow">   
                <div className="relative">
                    ...
                    type="search" id="default-search" className="block w-full p-4 ps-10 text-sm text-gray-900 border outline-none border-gray-300 rounded-full bg-gray-50 dark:bg-slate-900 focus:border-green-500 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-green-500" placeholder="Search blogs..." required />
                </div>
            </div>
            {
